package pl.rengreen.tasklist.start;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        //USERS --------------------------------------------------------------------------------------------------------
        //1
        User admin = new User("admin@mail.com", "admin", "admin", "images/admin.png");
        userService.createAdmin(admin);
        logger.info("saved user: " + admin.getName());

        //2
        User manager = new User("manager@mail.com", "manager", "manager", "images/admin.png");
        userService.createAdmin(manager);
        logger.info("saved user: " + manager.getName());

        //3
        User user = new User("marsel@mail.com", "Marsel", "11111111", "images/admin.png");
        userService.createUser(user);
        logger.info("saved user: " + user.getName());

        //4
        user = new User("argen@mail.com", "Argen", "11111111", "images/admin.png");
        userService.createUser(user);
        logger.info("saved user: " + user.getName());

        //5
        user = new User("sanjar@mail.com", "Sanjar", "11111111", "images/admin.png");
        userService.createUser(user);
        logger.info("saved user: " + user.getName());

        //6
        user = new User("manas@mail.com", "Manas", "11111111", "images/admin.png");
        userService.createUser(user);
        logger.info("saved user: " + user.getName());
        User userKate = new User();

        //7
        user = new User("semetey@mail.com", "Semetey", "11111111", "images/admin.png");
        userService.createUser(user);
        logger.info("saved user: " + user.getName());
        ...
        task = new Task(
                ...
                today.minusDays(40),
                true,
                userService.getUserByEmail("marsel@mail.com"),
                userService.getUserByEmail("marsel@mail.com")
        );
        taskService.createTask(task);
        logger.info("saved task: '" + task.getName() + "' for owner: " + taskService.getOwnerNameOrNoOwner(task));
        ...
        task = new Task(
                ...
                today.minusDays(30),
                true,
                userService.getUserByEmail("argen@mail.com"),
                userService.getUserByEmail("argen@mail.com")
        );
        taskService.createTask(task);
        logger.info("saved task: '" + task.getName() + "' for user: " + taskService.getOwnerNameOrNoOwner(task));
        ...
        task = new Task(
                ...
                today.minusDays(20),
                true,
                userService.getUserByEmail("semetey@mail.com"),
                userService.getUserByEmail("semetey@mail.com")
        );
        taskService.createTask(task);
        logger.info("saved task: '" + task.getName() + "' for user: " + taskService.getOwnerNameOrNoOwner(task));
        ...
        task = new Task(
                ...
                today.minusDays(10),
                true,
                userService.getUserByEmail("manas@mail.com"),
                userService.getUserByEmail("manas@mail.com")
        );
        taskService.createTask(task);
        logger.info("saved task: '" + task.getName() + "' for user: " + taskService.getOwnerNameOrNoOwner(task));
        ...
        task = new Task(
                ...
                false,
                userService.getUserByEmail("admin@mail.com"),
                userService.getUserByEmail("sanjar@mail.com")
        );
        taskService.createTask(task);
        logger.info("saved task: '" + task.getName() + "' for user: " + taskService.getOwnerNameOrNoOwner(task));
